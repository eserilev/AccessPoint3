...
<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="member_hedis.aspx.vb" Inherits="AccessPoint3.member_hedis" %>
      ...
      <asp:UpdatePanel ID="UpdatePanel1" runat="server">
       <ContentTemplate>
           <div style="position:center">
               ...
               <table class="siteFont" style="margin-left:42%; margin-top:70px; ">
